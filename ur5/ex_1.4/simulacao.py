...
Kd = np.diag([100000, 100000, 100000, 100000, 100000, 100000]) #N.m.s/rad
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while data.time <= 8.0:
        ...
        posicao_juntas_referencia = referencia_senoidal(t)
...
trajetoria_referencia = [referencia_senoidal(ti) for ti in intervalo]
